...
public class OffertaService {
    ...
    public void save(OffertaForm f, String ownerUser) throws Exception {
        ...
        o.setNote(f.note()); o.setTrasporto(f.trasporto()); o.setItemsJson(mapper.writeValueAsString(cart.items())); o.setTotale(cart.total()); repo.save(o, ownerUser);
    }
    public List<SavedOfferta> all(String ownerUser) throws SQLException { return repo.findAll(ownerUser); }
    public Optional<SavedOfferta> find(int id, String ownerUser) throws SQLException { return repo.findById(id, ownerUser); }
    public void delete(int id, String ownerUser) throws SQLException { repo.delete(id, ownerUser); }
